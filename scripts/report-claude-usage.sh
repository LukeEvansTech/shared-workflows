...
#
# Invoked by .github/workflows/renovate-review.yml (the reusable), which checks
# this repository out at `job.workflow_sha` so the script always matches the
# pinned workflow. Do NOT copy it back into caller repositories — that
# duplication is what this extraction removed.
#
